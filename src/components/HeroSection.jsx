...
const HeroSection = () => {
    return (
        <div className="bg-[url('https://i.ibb.co.com/bR8bdgzD/hero-bg.jpg')] h-[300px] sm:h-[400px] bg-cover bg-center">
            ...
            <Link to='/signUp' className='flex justify-center sm:justify-normal'><button className='btn bg-base-300 sm:ml-15 mt-4 rounded-sm text-[#2E7D32] border-3 hover:border-[#2E7D32]'>Join Community</button></Link>
        </div>
    );
};
